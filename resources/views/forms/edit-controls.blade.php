    ...
    <div id="collapse{{$data['numberOfElement']}}" class="collapse show" data-parent="#accordion">
        <div class="card-body">
            <div id="cont">
                ...
                <input id="id_{{$data['numberOfElement']}}" type="hidden" name="id_{{$data['numberOfElement']}}" value="{{$field->id}}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input id="form_id_{{$data['numberOfElement']}}" name="form_id_{{$data['numberOfElement']}}" type="text" placeholder="Enter the form id"
                                   class="form-control required"   value="{!! old('form_id_' . $data['numberOfElement'], $field->form_id) !!}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input id="input_id_{{$data['numberOfElement']}}" name="input_id_{{$data['numberOfElement']}}" type="text" placeholder="Enter the input id"
                                   class="form-control required"   value="{!! old('input_id_'. $data['numberOfElement'], $field->input_id) !!}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input id="input_type_{{$data['numberOfElement']}}" name="input_type_{{$data['numberOfElement']}}" type="text" placeholder="Enter the input type"
                                   class="form-control required"   value="{!! old('input_type_'. $data['numberOfElement'], $field->input_type) !!}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input id="input_name_{{$data['numberOfElement']}}" name="input_name_{{$data['numberOfElement']}}" type="text" placeholder="Enter the input name"
                                   class="form-control required"   value="{!! old('input_name_' . $data['numberOfElement'], $field->input_name) !!}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input id="label_title_{{$data['numberOfElement']}}" name="label_title_{{$data['numberOfElement']}}" type="text" placeholder="Enter the label title"
                                   class="form-control required"   value="{!! old('label_title_' . $data['numberOfElement'], $field->label_title) !!}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input id="primary_color_{{$data['numberOfElement']}}" name="primary_color_{{$data['numberOfElement']}}" type="text" placeholder="Enter the primary color"
                                   class="form-control required"   value="{!! old('primary_color_' . $data['numberOfElement'], $field->primary_color) !!}" />
