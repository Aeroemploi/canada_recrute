		...
		<td background="" align="center">
						...
						<td width="552" valign="top" align="left">
							...
							<tbody><tr>
								<td class="" width="264" valign="middle" align="left">
									<a href="http://canadarecrute.com" target="_blank">
										<img src="{{asset('assets/images/logo_canada_fr.png')}}" alt="" editable="" label="Logo" class="" width="264" height="25" border="0">
									</a>
								</td>
							</tr>
							</tbody></table>
			...
			<tr>
				...
				<td valign="top" align="left">
					<div class="h1"><single label="Headline"># Bienvenue  {!! $user_array['first_name'] !!} {!! $user_array['last_name'] !!},</single></div>
					<div class="h2"><multi label="Intro Sentence"><p>Nous vous remercions de votre inscription pour l'événement de clavardage en direct. Si votre candidature est retenue, un recruteur vous contactera.<br /> Cordialement,</multi></div>
				</td>
				<td class="padd" width="24">&nbsp;</td>
			</tr>
						...
						<td width="552" valign="top" align="left">
							...
							<tbody><tr>
								<td class="small m-b" width="552" valign="top" align="left">
									...
									<div><single label="Copyright">&copy; 2018 Tous les droits réservé à Canada Recrute</single></div>
								</td>
							</tr>
							</tbody></table>
							<table cellspacing="0" cellpadding="0" align="left">
							<tbody><tr>
								...
								<div class="btn">Propulsé par</div>
								</td>
								<td class="small" width="226" valign="top" align="left"><a href="https://aeroemploi.ca/"><img src="{{asset('assets/images/mini_logo_aeroemploi_fr.png')}}" alt="" width="115" height="50" border="0"></a></td>
								<td class="small" width="226" valign="top" align="left"><a href="https://auray.com/"><img src="{{asset('assets/images/mini_logo_auray_sourcing_fr.png')}}" alt="" width="115" height="50" border="0"></a></td>
							</tr>
							</tbody></table>
						</td>
